...
contract Trades is ChainlinkClient {
   ...
   /////////////////
    ...
    function createTrack(
     ...
     function requestCryptoData() public returns (bytes32 requestId) {
   ...
   Chainlink.Request memory req = buildChainlinkRequest(
        ...
        req.add("path", "data,1,quote,USD,volume_24h");
        req.add("path", "data,1027,quote,USD,volume_24h");
        req.add("path", "data,1839,quote,USD,volume_24h");
        req.add("path", "data,1,quote,USD,volume_24h,volume_change_24h");
        req.add("path", "data,1027,quote,USD,volume_24h,volume_change_24h");
        req.add("path", "data,1839,quote,USD,volume_24h,volume_change_24h");
        req.add("path", "data,1,quote,USD,volume_24h,volume_change_24h,percent_change_1h");
        req.add("path", "data,1027,quote,USD,volume_24h,volume_change_24h,percent_change_1h");
        req.add("path", "data,1839,quote,USD,volume_24h,volume_change_24h,percent_change_1h");
